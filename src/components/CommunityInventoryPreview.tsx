            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {listings.map((l) => (
                <Link
                  ...
                  key={l.id}
                  className="bg-card/80 dark:bg-white/5 backdrop-blur-xl rounded-lg overflow-hidden shadow-card hover:shadow-elevated transition-all duration-300 border border-border/60 dark:border-white/10 group block"
                >
